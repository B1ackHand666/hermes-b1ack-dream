...
const parseArgs = () => {
    ...
    const valueFor = (name) => values.at(values.indexOf(name) + 1);
...
if (webServer) {
    ...
    if (!address || typeof address === "string")
        throw new Error("WebUI server has no TCP address");
    ...
    switch (request.method) {
        ...
        case "capture_turn": {
            ...
            if (!userContent || !assistantContent)
                throw new Error("Completed turn requires userContent and assistantContent.");
